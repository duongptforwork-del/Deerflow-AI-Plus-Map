...
export default async function PostDetailPage({ params: { lang, category, slug } }: { params: { lang: string; category: string; slug: string } }) {
 ...
 <span className="inline-block bg-[#ef4444] text-black px-4 py-1 font-black text-xs uppercase tracking-widest border-2 border-black skew-x-[-10deg]">
 <span className="inline-block skew-x-[10deg]">{post.section?.toUpperCase() || 'INTELLIGENCE'}</span>
 </span>
 ...
 <h1 className="group-hover:text-[#ef4444] transition-colors text-2xl md:text-3xl lg:text-4xl font-display font-black leading-tight mb-8 tracking-tight">
 {post.title}
 </h1>
 ...
 <button className="border-4 border-black px-6 py-2 bg-white font-black uppercase text-sm shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] group transition-colors">
 <span className="group-hover:text-[#ef4444] transition-colors">Share</span>
 </button>
 <button className="border-4 border-black px-6 py-2 bg-black text-white font-black uppercase text-sm shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] group transition-colors">
