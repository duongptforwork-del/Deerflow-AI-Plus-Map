      ...
      <main className="max-w-4xl mx-auto px-4 py-20">
        <article>
          <header className="mb-12">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-black leading-tight mb-8 tracking-tight text-balance">
              {post.title}
            </h1>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-bold text-xs text-slate-500 uppercase mt-1">Guide & Knowledge Division</p>
                </div>
              </div>
            </div>
          </div>
