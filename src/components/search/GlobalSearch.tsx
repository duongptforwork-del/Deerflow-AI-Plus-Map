  ...
  return (
    <>
      <button 
        ...
        className="flex items-center gap-4 px-4 py-2 border-4 border-black bg-white hover:bg-yellow-50 transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-none translate-y-0 hover:translate-x-1 hover:translate-y-1"
      >
        <Search size={18} />
        <span className="font-black text-xs uppercase hidden lg:inline">{t.search_btn}</span>
        <kbd className="hidden lg:flex items-center gap-1 px-1.5 py-0.5 border-4 border-black bg-white text-[10px] font-mono shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
          ⌘K
        </kbd>
      </button>
          ...
          >
            <div className="flex items-center border-b-4 border-black p-4 bg-white">
              ...
              <button 
                ...
                className="p-2 border-4 border-transparent hover:border-black hover:bg-yellow-50 hover:text-black hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all hover:-translate-x-1 hover:-translate-y-1"
              >
                <X size={20} />
              </button>
            </div>
            ...
            <div className="border-t-4 border-black p-3 bg-white flex justify-between items-center px-6">
              <div className="flex gap-4">
                <span className="text-[9px] font-black uppercase text-black/50"><kbd className="border-4 border-black px-1 bg-white mr-1 text-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">ENTER</kbd> {t.select}</span>
                <span className="text-[9px] font-black uppercase text-black/50"><kbd className="border-4 border-black px-1 bg-white mr-1 text-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">ESC</kbd> {t.close}</span>
              </div>
