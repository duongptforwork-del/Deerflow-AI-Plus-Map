...
export default function AdminEditor({ isNew = true, postId, lang = 'en' }: AdminEditorProps) {
 ...
 <button onClick={() => router.push(`/${lang}/xyz_safe`)} className="p-2 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
 <ArrowLeft size={20} />
 </button>
 ...
 className="px-6 py-2 bg-white text-black border-4 border-black font-black uppercase text-sm tracking-widest shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
 >
 ...
 disabled={isSaving || isTranslating}
 className="flex items-center gap-2 px-6 py-2 bg-[#ef4444] text-black border-4 border-black font-black uppercase text-sm tracking-widest shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
 >
 ...
 disabled={isSaving || isTranslating}
 className="flex items-center gap-2 px-6 py-2 bg-yellow-50 text-black border-4 border-black font-black uppercase text-sm tracking-widest shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
 >
 ...
 className="w-full p-3 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] outline-none font-bold text-black text-sm"
 />
 </div>
 <div>
 ...
 className="w-full p-3 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] outline-none font-bold text-black text-sm uppercase tracking-widest"
 >
 ...
 className="flex-1 p-3 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] outline-none font-bold text-black text-sm uppercase tracking-widest"
 >
 {authors.map((auth) => (
 ...
 className="px-4 py-2 bg-white text-black border-4 border-black font-black uppercase text-xs shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
 ...
 className="px-4 py-2 bg-white text-[#ef4444] border-4 border-black font-black uppercase text-xs shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
 ...
 className="w-full p-3 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] outline-none font-bold text-black text-sm h-24 resize-none"
 ...
 <div className="flex items-center gap-4">
 <label className="group cursor-pointer bg-white border-4 border-black px-4 py-2 font-bold text-xs uppercase tracking-widest shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
 <span className="group-hover:text-[#ef4444] transition-colors">{uploadingImage ? 'Uploading...' : 'Upload Image'}</span>
 ...
 <Image fill src={featuredImage} alt="Featured"className="w-full h-full object-cover" onError={(e) => { e.currentTarget.src = '/placeholder.png'; }} />
 </div>
 )}
 </div>
 </div>
 ...
 <button type="button" onClick={() => applyHeading('<h1>')} title="Heading 1" className="group p-2 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"><span className="group-hover:text-[#ef4444] transition-colors"><Heading1 size={16} /></span></button>
 <button type="button" onClick={() => applyHeading('<h2>')} title="Heading 2" className="group p-2 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"><span className="group-hover:text-[#ef4444] transition-colors"><Heading2 size={16} /></span></button>
 <button type="button" onClick={() => applyHeading('<h3>')} title="Heading 3" className="group p-2 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"><span className="group-hover:text-[#ef4444] transition-colors"><Heading3 size={16} /></span></button>
 <div className="w-px h-6 bg-black mx-1"></div>
 <button type="button" onClick={() => applyStyle('bold')} title="Bold" className="group p-2 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"><span className="group-hover:text-[#ef4444] transition-colors"><Bold size={16} /></span></button>
 <button type="button" onClick={() => applyStyle('italic')} title="Italic" className="group p-2 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"><span className="group-hover:text-[#ef4444] transition-colors"><Italic size={16} /></span></button>
 <div className="w-px h-6 bg-black mx-1"></div>
 <button type="button" onClick={applyLink} title="Link" className="group p-2 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"><span className="group-hover:text-[#ef4444] transition-colors"><LinkIcon size={16} /></span></button>
 
 <label className="group cursor-pointer p-2 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center" title="Upload Image to Content">
 <span className="group-hover:text-[#ef4444] transition-colors"><ImageIcon size={16} /></span>
 ...
 className="flex-1 w-full p-6 bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] outline-none font-bold text-black overflow-y-auto font-sans text-base leading-relaxed prose prose-lg max-w-none 
 ...
 <span className="bg-[#ef4444] text-black px-4 py-1 font-black text-xs uppercase tracking-widest border-4 border-black skew-x-[-10deg]">
 {section.toUpperCase()}
 </span>
 </div>
 
 <h1 className="group-hover:text-[#ef4444] transition-colors text-2xl md:text-4xl font-black leading-tight mb-8 tracking-tight">
 ...
 <Image fill src={featuredImage} alt={title} className="w-full h-full object-cover" onError={(e) => { e.currentTarget.src = '/placeholder.png'; }} />
 </div>
 )}
...
">
 ...
 className="group font-black text-xl"
 >
 <span className="group-hover:text-[#ef4444] transition-colors text-black">✕</span>
 </button>
 </div>
 ...
 <label 
 key={l.code} 
 className="flex items-center gap-3 p-3 bg-white border-4 border-black font-black uppercase text-xs cursor-pointer shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] select-none"
 >
 <input 
 type="checkbox"
 ...
 <button
 onClick={() => setIsTranslateModalOpen(false)}
 className="flex-1 py-3 bg-white text-black border-4 border-black font-black uppercase text-xs shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
 >
 Cancel
 </button>
 <button
 onClick={executeTranslations}
 className="flex-1 py-3 bg-[#ef4444] text-black border-4 border-black font-black uppercase text-xs shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
 >
 Start Translation
 </button>
 </div>
