...
export default function Footer({ lang }: { lang: string }) {
 ...
 return (
 <footer className="bg-black text-white pt-20 pb-10 border-t-4 border-[#ef4444]">
 <div className="max-w-7xl mx-auto px-4">
 <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
 <div className="col-span-2">
 <div className="flex items-center gap-4 mb-10 group">
 <div className="bg-[#ef4444] border-4 border-black p-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
 ...
 <span className="text-5xl font-display font-black tracking-tighter leading-none group-hover:text-[#ef4444] transition-colors">AI PLUS MAP</span>
 </div>
 </div>
 ...
 <li><Link href={`/${lang}/news`} className="group block transition-colors"><span className="group-hover:text-[#ef4444] transition-colors">{t.news_feed}</span></Link></li>


 <li><Link href={`/${lang}/events`} className="group block transition-colors"><span className="group-hover:text-[#ef4444] transition-colors">{t.industry_events}</span></Link></li>
 </ul>
 </div>
 ...
 <div className="group w-10 h-10 border-2 border-white flex items-center justify-center cursor-pointer transition-colors">
 <span className="font-black group-hover:text-[#ef4444] transition-colors">TW</span>
 </div>
 <div className="group w-10 h-10 border-2 border-white flex items-center justify-center cursor-pointer transition-colors">
 <span className="font-black group-hover:text-[#ef4444] transition-colors">FB</span>
 </div>
 <div className="group w-10 h-10 border-2 border-white flex items-center justify-center cursor-pointer transition-colors">
 <span className="font-black group-hover:text-[#ef4444] transition-colors">YT</span>
 </div>
 </div>
 </div>
 ...
 <Link href="#" className="group"><span className="group-hover:text-white transition-colors">{t.privacy}</span></Link>
 <Link href="#" className="group"><span className="group-hover:text-white transition-colors">{t.terms}</span></Link>
 </div>
 </div>
 </div>
 </footer>
